@echo off
echo ========================================
echo DEMARRAGE BACKEND OPERATIONNEL SEULEMENT
echo EduSchedule - Services Backend
echo ========================================
echo.

echo Demarrage des services backend operationnels uniquement...
echo Services inclus: Eureka, User, Course, Reservation, Scheduling, Notification, Resource, School, API Gateway
echo.

echo [1/9] Demarrage d'Eureka Server...
cd eureka-server
...
echo.
echo [2/9] Demarrage du User Service...
cd user-service
...
echo.
echo [3/9] Demarrage du Course Service...
cd course-service
...
echo.
echo [4/9] Demarrage du Reservation Service...
...
echo.
echo [5/9] Demarrage du Scheduling Service...
...
echo.
echo [6/9] Demarrage du Notification Service...
...
echo.
echo [7/9] Demarrage du Resource Service...
cd resource-service
...
echo.
echo [8/9] Demarrage du School Service...
cd school-service
...
echo.
echo [9/9] Demarrage de l'API Gateway...
cd api-gateway
...
echo.
echo ========================================
echo SERVICES BACKEND OPERATIONNELS DEMARRES !
echo ========================================
echo.
...
echo   .\quick-test-system.ps1     - Test rapide
echo.
...
echo - Teacher Availability Service (en developpement)
