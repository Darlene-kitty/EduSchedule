...
Write-Host "=== Démarrage de l'Event Service ===" -ForegroundColor Green
...
Write-Host "`nDémarrage de l'Event Service..." -ForegroundColor Yellow
Write-Host "Port: 8089" -ForegroundColor Cyan
Write-Host "Endpoints disponibles:" -ForegroundColor Cyan
Write-Host "  - GET  /api/v1/events/test" -ForegroundColor Gray
Write-Host "  - POST /api/v1/events" -ForegroundColor Gray
Write-Host "  - GET  /api/v1/events" -ForegroundColor Gray
Write-Host "  - GET  /api/v1/events/{id}" -ForegroundColor Gray
Write-Host "  - GET  /api/v1/events/upcoming" -ForegroundColor Gray
Write-Host "  - GET  /api/v1/events/today" -ForegroundColor Gray
Write-Host "  - GET  /api/v1/events/conflicts/check" -ForegroundColor Gray
Write-Host "  - GET  /api/v1/events/availability/check" -ForegroundColor Gray
Write-Host "`nPour tester le service, utilisez: .\test-event-service.ps1" -ForegroundColor Green
